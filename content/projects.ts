...
export const projects: Project[] = [
  ...
  },
  {
    ...
    featured: false,
    name: "Angelic Weaves",
    website: "https://angelicweaves.com",
    industry: "Womens Fashion eCommerce",
    role: "Shopify Developer",
    duration: "Client project",
    teamSize: "Agency collaboration",
  ...
  },
  {
    ...
    featured: false,
    name: "Enzymatic Enviro",
    website: null,
    industry: "Wastewater Treatment and Environmental Services",
    role: "WordPress Developer",
    duration: "Client project",
    teamSize: "Solo implementation",
    overview:
      "A WordPress maintenance and optimization project focused on theme cleanup, storefront usability, and integration support.",
    clientGoal:
      "Improve the reliability and day-to-day usability of an existing WordPress site without rebuilding the storefront from scratch.",
    responsibilities: [
    ...
    technologies: ["WordPress", "PHP", "JavaScript", "CSS", "WordPress Plugins"],
    features: [
      "Theme cleanup",
    ...
    learning:
      "This work strengthened my habit of solving WordPress issues with focused, low-risk changes that respect the existing site structure.",
    publiclyAvailable: false,
